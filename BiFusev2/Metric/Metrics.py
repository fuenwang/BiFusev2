...
class MovingAverageEstimator(object):
    ...
    def __init__(self, field_names, max_depth=10.0, align_median=True):
        self.field_names = field_names
        self.align_median = align_median
        self.metrics = Metrics(field_names, max_depth)
...
class Metrics(object):
    """ Benchmark """
    def __init__(self, field_names, max_depth):
    ...
    def compute(self, pred, depth, align_median):
        ...
        valid_mask = (depth > 0.01) & (depth < self.max_depth)
